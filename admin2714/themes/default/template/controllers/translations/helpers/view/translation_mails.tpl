				...
				//<![CDATA[
					$(document).ready(function () {
						$('.mails_field').on('shown.bs.collapse', function () {
							...
							rte_mail_config['plugins'] = "colorpicker link image paste shortcodes preview pagebreak table contextmenu filemanager table code media autoresize textcolor anchor fullpage";
