...
<div id="login-panel">
	<!--<div id="login-header">
		<h1 class="text-center">
			<img id="logo" src="{$img_dir}prestashop@2x.png" alt="FluzFluz" />
		</h1>
...
<br>
	<div id="shop-img"><img src="{$img_dir}preston-login@2x.png" alt="{$shop_name}" /></div>
	<div class="flip-container" style="margin-top:30px;">
		<div class="flipper">
			<div class="front panel">
				...
				<form action="#" id="login_form" method="post">
					...
					<div class="form-group">
						...
						<input name="email" type="email" id="email" class="form-control" value="{if isset($email)}{$email|escape:'html':'UTF-8'}{/if}" autofocus="autofocus" tabindex="1" placeholder="&#xf0e0 usuario@correo.com" />
					</div>
					<div class="form-group">
