	...
	{/if*}
        <div class="row banner-container">
            <div class="col-xs-12 col-sm-12 signup-account">
                <img src="{$img_dir}login/banner_business.jpg" id="banner_login" />
            </div>
        </div>
        <div class="row sign-account">
            <div class="col-xs-12 col-sm-12 col-lg-12 signup-account">
                <div class="info-box">
                    <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
                        <h3 class="page-subheading borde-inf">{l s='Beneficios Corporativos'}</h3>
                        ...
                        <div class="form_content clearfix">
                            ...
                            <p class="lost_password form-group"><a href="{$link->getPageLink('password')|escape:'html':'UTF-8'}" title="{l s='Recover your forgotten password'}" rel="nofollow" style="text-decoration:underline;">Olvidaste tu contrase&ntilde;a, Fluzzer?</a></p>
                        </div>
                        <div class="line-separator"></div>
                        <div class="row footer-sign">
                            <span class="lost_password form-group">No tienes Cuenta?
                                <a href="#" style='color: #ef4136;font-size: 14px;font-weight: lighter;'> Crea Una Ahora.</a></span>
                        </div>
                    </form>
                </div>
            </div>
...
{literal}
    <style>
       ...
       div.account_creation {
        ...
        .info-box p a{font-size: 12px;
                        color: #BDBDBD;
                        font-family:  arial;}
        .button.button-medium{border: 0;
                        background: #c9b197;
                        color: #fff;
                        text-transform: uppercase;
                        padding: 10px 15px;
