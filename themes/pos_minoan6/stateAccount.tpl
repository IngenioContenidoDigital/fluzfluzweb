{capture name=path}{l s='stateaccount'}{/capture}
    ...
    <div class="row bck-stats">
        <div class="row">
            <p class="col-lg-7 col-md-7 col-sm-6 col-xs-6 item-list-account">Tama&ntilde;o de Network:</p>
            <p class="col-lg-5 col-md-5 col-sm-6 col-xs-6 data-r">{$tam_network}</p>
        </div>
        <div class="row">
            <p class="col-lg-7 col-md-7 col-sm-6 col-xs-6 item-list-account">Nuevos miembros en su network este mes:</p>
            <p class="col-lg-5 col-md-5 col-sm-6 col-xs-6 data-r">{$numero_de_cuenta}</p>
        </div>
        <div class="row">
            <p class="col-lg-7 col-md-7 col-sm-6 col-xs-6 item-list-account">Fluz ganados:</p>
             <p class="col-lg-5 col-md-5 col-sm-6 col-xs-6 data-r">{$lastPoint.points|string_format:"%d"}</p>
        </div>
        <div class="row">
            <p class="col-lg-7 col-md-7 col-sm-6 col-xs-6 item-list-account">COP valor de Fluz:</p>
        ...
        <div class="row">
            <p class="col-lg-7 col-md-7 col-sm-6 col-xs-6 item-list-account"># de pedidos:</p>
             <p class="col-lg-5 col-md-5 col-sm-6 col-xs-6 data-r">{$num_orders.orders}</p>
        </div>
        <div class="row">
            <p class="col-lg-7 col-md-7 col-sm-6 col-xs-6 item-list-account">Bonos comprados:</p>
             <p class="col-lg-5 col-md-5 col-sm-6 col-xs-6 data-r">{$num_orders.num_bonos}</p>
        </div>
        <div class="row">
            <p class="col-lg-7 col-md-7 col-sm-6 col-xs-6 item-list-account">Valor de la tienda en bonos:</p>
    ...
    <div class="row margin-div">
        <p class="p-state">{l s='Compare su rendimiento del mes'}</p>
    </div>
    <div class="row">
    ...
    <div class="row">
        <h4 class="t-act"> Mejor Fluzzer </h4>
    </div> 
    <div class="row bck-stats">
