			...
			{/if}
				...
				<div class="pb-left-column col-lg-3 col-xs-12 col-sm-6 col-md-5">
					...
					<div class="clearfix">
						...
						{else}
							<span id="view_full_size">
								<img itemprop="image" src="{$s3}m/m/{$product->id_manufacturer}.jpg" id="bigpic" alt="" title="{$product->name|escape:'html':'UTF-8'}" width="{$largeSize.width}" height="{$largeSize.height}"/>
								{if !$content_only}
									...
									{*if !$PS_CATALOG_MODE*}
                                                                        ...
                                                                        {foreach from=$combinationsList item=list}
                                                                            ...
                                                                            <div class="content-table-combinations row"> 
                                                                                ...
                                                                                {/if*}    
                                                                                {if $logged AND $list.reference|substr:0:5 != 'MFLUZ'}
                                                                                ...
                                                                                {elseif $logged AND $list.reference|substr:0:5 == 'MFLUZ'}
                                                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 item-list point_fluz" style="color:#ef4136;">+&nbsp;{((($list.price/(int)Configuration::get('REWARDS_VIRTUAL_VALUE_1'))*$list.value))|string_format:"%d"}</div>
                                                                                {else}
										...
										<div class="item-product">
											<div class="products-inner">
												<a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.legend|escape:'html':'UTF-8'}" class="product-image product_image">
													<img class="img-responsive" src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'thickbox_default')|escape:'html':'UTF-8'}" alt="{$accessory.legend|escape:'html':'UTF-8'}" width="{$homeSize.width}" height="{$homeSize.height}"/>
												</a>
