                    ...
                    <tr>
                        <td>
                            <table class="tablecontent">
                                ...
                                <tr>
                                    <td><span class="information">{l s='Points Contributed:'} </span><span class="data">43</span></td>
                                    <td><span class="information">{l s='Network Level:'} </span><span class="data">10</span></td>
