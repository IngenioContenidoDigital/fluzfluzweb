...
$query_Abandonment = 'SELECT
                        ...
                        cu.id_currency,
                        a.id_cart,
                        IF (IFNULL(o.id_order, \''.'No ordenado'.'\') = \''.'No ordenado'.'\', IF(TIME_TO_SEC(TIMEDIFF(\''.pSQL(date('Y-m-d H:i:00', time())).'\', a.`date_upd`)) > 600, \''.'Carrito abandonado'.'\', \''.'No ordenado'.'\'), o.id_order) AS status
