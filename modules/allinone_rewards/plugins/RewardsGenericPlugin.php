		...
		if ($tab==Tools::getValue('plugin') && $id_template) {
			...
			$html .= '
							...
							<div class="clear" style="padding-top: 20px">
								...
								<select class="add_from_group" name="add_from_group" onChange="addTemplateCustomersFromGroup(\''.$this->l('Do you really want to add customers from that group ?', null, 'rewardsgenericplugin').'\', \''.$this->l('Add from a group', null, 'rewardsgenericplugin').'\')"/>
