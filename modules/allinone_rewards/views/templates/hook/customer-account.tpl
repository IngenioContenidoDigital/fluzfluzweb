...
<li><a href="{$link->getModuleLink('allinone_rewards', 'rewards', [], true)|escape:'html':'UTF-8'}" title="{l s='My rewards account' mod='allinone_rewards'}"><img src="{$img_dir}icon/statics.png" class="imgSponsor" /><span class="spanSponsor">{l s='Statistic' mod='allinone_rewards'}</span></a></li>
{else}
