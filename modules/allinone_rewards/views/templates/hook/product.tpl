...
{else}
	{if $display_credits}
            {l s='Buying this product you will collect ' mod='allinone_rewards'} <b><span id="loyalty_credits" class="colorPoint">{$credits|escape:'htmlall':'UTF-8'}</span></b> <span class="colorPoint2">{l s=' with our loyalty program.' mod='allinone_rewards'} </span>
